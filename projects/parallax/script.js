...
/**
 * Calulate element position in relation to page top
...
class Parallax {
    ...
    onScroll() {
        ...
        this.element.style.setProperty("opacity", `0.5`); 
        this.element.style.setProperty("transform", `translateY(${-diffY * this.ratio}px)`); 
        this.element.style.setProperty("transform", `translateX(${-diffY * this.ratio}px)`); 
    }
